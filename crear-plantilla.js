...
async function main() {
  ...
  sheet.addRows([
    { familia: 'Familia Pérez', pases: 4, whatsapp: '573001234567' },
    { familia: 'Familia Gómez', pases: 2, whatsapp: '' },
    { familia: 'Ana y Luis', pases: 2, whatsapp: '573007654321' },
  ]);
  ...
  [
    ...
    '4) No cambies los nombres de las columnas ni el nombre de la hoja "Invitados".',
    '5) Agrega todas las filas que necesites, una por familia/grupo.',
    '6) Guarda el archivo y corre: node generar-invitaciones.js',
